...
export const SEO_DEFAULT_OG_IMAGE_URL = `${SEO_BASE_URL}/sample/og/ChatGPT%20Image%202026%EB%85%84%203%EC%9B%94%2022%EC%9D%BC%20%EC%98%A4%ED%9B%84%2003_51_13.png`;
