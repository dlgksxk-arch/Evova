export type Category = 'face' | 'clothes';
...
const generateSamples = (prefix: string, count: number, category: Category, subCategory: SubCategory, displayNamePrefix: string, country: string | null, descriptionStr: string): SampleImage[] => {
