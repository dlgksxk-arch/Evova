...
const landingContent: Record<SupportedLandingLanguage, LandingContent> = {
  ko: {
    hero: {
      eyebrow: 'AI Pet Outfit Preview',
      title: '사기 전에,\n먼저 입혀보세요',
      subtitle: '강아지나 고양이 사진에 의상 이미지를 넣고 미리보기를 바로 확인할 수 있습니다.',
      body: 'HAMDEVA는 dogs and cats를 위한 AI pet outfit try-on / outfit preview tool입니다.',
      compactPrimaryButton: 'Try On',
      primaryButton: 'AI 펫 의상 생성기 열기',
      secondaryButton: '의상 아이디어 보기',
    },
    intro: {
      title: 'HAMDEVA는 강아지와 고양이를 위한 AI pet outfit try-on 허브입니다.',
      paragraphs: [
        '홈에서는 HAMDEVA가 무엇인지 빠르게 이해하고, 바로 생성 도구나 의상 아이디어 페이지로 이동할 수 있습니다.',
        '강아지나 고양이 사진과 의상 이미지를 넣으면, 구매나 촬영 전에 어떤 분위기가 잘 맞는지 먼저 비교할 수 있습니다.',
        '일상룩, 후드티, 할로윈 코스튬, 한복, 포멀룩처럼 의도가 다른 페이지를 나눠 두어 더 빠르게 시작할 수 있게 구성했습니다.',
      ],
    },
    features: {
      title: '이렇게 바로 이해됩니다',
      items: [
        {
          title: '반려동물 사진 업로드',
          description: '강아지나 고양이 사진 한 장이면 시작할 수 있습니다.',
        },
        {
          title: '의상 이미지 추가',
          description: '마음에 드는 의상 사진을 넣으면 룩 방향이 바로 달라집니다.',
        },
        {
          title: 'AI 미리보기 생성',
          description: '몇 초 안에 비교 가능한 결과 이미지를 확인할 수 있습니다.',
        },
        {
          title: '저장 후 비교',
          description: '마음에 드는 룩은 저장하고 다음 의상과 빠르게 비교할 수 있습니다.',
        },
      ],
    },
    steps: {
      title: '3단계로 바로 써볼 수 있습니다',
      items: [
        { step: '01', title: '반려동물 사진 업로드', description: '얼굴과 상체가 잘 보이는 강아지 또는 고양이 사진을 고릅니다.' },
        { step: '02', title: '의상 이미지 추가', description: '직접 준비한 의상 이미지나 샘플 의상을 넣습니다.' },
        { step: '03', title: '생성 후 비교', description: '결과를 보고 어떤 스타일이 더 잘 맞는지 비교합니다.' },
      ],
    },
    examples: {
      title: '이런 검색 의도에 맞습니다',
      items: [
        { title: 'dog clothes try on', description: '실제로 사기 전에 강아지 옷 분위기를 먼저 비교합니다.' },
        { title: 'cat outfit generator', description: '고양이 프로필 사진이나 이벤트 룩을 빠르게 테스트합니다.' },
        { title: 'pet halloween costume', description: '시즌 코스튬을 미리 확인하고 과한지 가벼운지 비교합니다.' },
        { title: 'pet outfit ideas', description: '의상 이미지가 아직 없을 때 방향부터 잡는 데 유용합니다.' },
      ],
    },
    sampleInfo: {
      title: '바로 생성하거나, 먼저 의상 아이디어를 둘러보세요',
      body: 'Try On 페이지에서 바로 생성할 수 있고, Outfit Ideas 페이지에서는 후드티, 할로윈, 한복, 포멀룩 같은 방향을 먼저 고를 수 있습니다.',
      button: 'Outfit Ideas 보기',
    },
    faq: {
      title: '자주 묻는 질문',
      items: [
    ...
    modal: {
      ...
      personCardBody: '얼굴이 잘 보이고 배경이 복잡하지 않은 사진이 더 안정적으로 나옵니다.',
      garmentCardTitle: '의상 이미지 업로드',
      garmentCardBody: '의상 전체 형태와 앞면 디테일이 잘 보이는 이미지를 고르면 결과가 더 또렷합니다.',
    ...
    sampleOutfits: {
      title: 'Outfit Ideas',
      description: '반려동물에게 어떤 의상 방향이 잘 맞을지 먼저 고르는 페이지입니다.',
      introTitle: '',
      introParagraphs: [],
      breedTitle: '샘플 반려동물',
      breedBody: '샘플 반려동물 이미지는 내 사진을 넣기 전, 얼굴 비율과 털 볼륨에 따라 룩이 어떻게 보일지 빠르게 테스트하는 데 유용합니다.',
      catalogTitle: '의상 레퍼런스 갤러리',
      catalogBody: '전통 의상은 여러 아이디어 중 하나로 두고, 전체적으로는 outfit ideas / costume ideas 허브처럼 활용할 수 있게 구성했습니다.',
  ...
  en: {
    hero: {
      eyebrow: 'AI Pet Outfit Preview',
      title: 'Preview Pet Outfits Before You Buy',
      subtitle: 'Upload a dog or cat photo, add an outfit image, and compare the look in seconds.',
      body: 'HAMDEVA is an AI pet outfit try-on and outfit preview tool for dogs and cats.',
      compactPrimaryButton: 'Try On',
      primaryButton: 'Open AI Pet Outfit Generator',
      secondaryButton: 'Browse Outfit Ideas',
    },
    intro: {
      title: 'HAMDEVA is built around one job: helping you preview dog and cat outfits quickly.',
      paragraphs: [
        'The homepage acts as a fast hub. It explains the product in one glance, shows real example results, and points you to the tool page or the outfit idea pages without forcing a long read first.',
        'Use it when you want a quick route into dog clothes try on, cat outfit generation, pet costume preview, or broader outfit idea browsing.',
        'If you already know the look you want, jump straight to a focused landing page such as dog outfit generator, cat outfit generator, pet Halloween costume, or pet hanbok.',
      ],
    },
    features: {
      title: 'What HAMDEVA helps you do',
      items: [
        { title: 'Upload your pet photo', description: 'Start with one clear dog or cat photo.' },
        { title: 'Add an outfit image', description: 'Use your own clothing image or a sample reference.' },
        { title: 'Generate a preview', description: 'Compare the outfit direction before you buy or post the final look.' },
        { title: 'Save the best result', description: 'Keep the look you prefer and compare it with the next option.' },
      ],
    },
    steps: {
      title: 'How the try-on flow works',
      items: [
    ...
    examples: {
      title: 'Popular reasons people use it',
      items: [
        { title: 'Dog clothes try on', description: 'Preview a dog outfit before you buy or post it.' },
        { title: 'Cat outfit generator', description: 'Test cat costume and profile-photo ideas quickly.' },
        { title: 'Pet Halloween costume', description: 'Compare seasonal costume ideas before you pick one.' },
        { title: 'Pet outfit ideas', description: 'Browse stronger starting points when you do not have a final clothing image yet.' },
      ],
    },
    sampleInfo: {
      title: 'Open the tool or browse outfit ideas first',
      body: 'Go straight to the try-on page when you are ready to generate, or use Outfit Ideas to choose between casual, formal, holiday, and traditional directions first.',
      button: 'Explore Outfit Ideas',
    },
    faq: {
    ...
    sampleOutfits: {
      ...
      introTitle: 'Use this page as your outfit ideas hub.',
      introParagraphs: [
        'This page is no longer only about traditional clothing. It is the main place to compare broader outfit directions before generation.',
        'Use it when you want to move from a vague idea like casual, formal, holiday, or traditional into a stronger outfit reference.',
      ],
      breedTitle: 'Sample Pets',
      breedBody: 'Sample pet images help you test different looks fast before you switch to your own dog or cat photo.',
      catalogTitle: 'Outfit Reference Gallery',
      catalogBody: 'Browse quick references here, then open a focused landing page or the try-on tool once you know the direction you want.',
