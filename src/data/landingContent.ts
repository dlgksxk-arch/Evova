...
const landingContent: Record<SupportedLandingLanguage, LandingContent> = {
  ko: {
    hero: {
      ...
      body:
        '강아지나 고양이 사진 한 장과 의상 이미지 한 장이면 귀여운 펫 의상 미리보기를 바로 만들 수 있어요.',
    ...
    modal: {
      ...
      notice: '반려동물 사진과 의상 이미지를 고르면 바로 펫 피팅을 시작할 수 있어요.',
      personCardTitle: '반려동물 사진 업로드',
      personCardBody: '강아지나 고양이가 잘 보이는 사진을 올리거나 샘플 친구를 바로 선택해보세요.',
      garmentCardTitle: '의상 이미지 업로드',
      garmentCardBody: '의상 사진을 올리거나 샘플 의상에서 원하는 스타일을 골라보세요.',
      actionCardTitle: '생성하기',
      actionCardBody: '사진과 의상을 고른 뒤 생성 버튼을 누르면 결과 이미지를 만들 수 있어요.',
      actionFootnote: '생성 시간은 이미지와 서버 상태에 따라 달라질 수 있습니다.',
      tipsTitle: '좋은 결과를 위한 팁',
      tips: ['반려동물이 또렷하게 보이는 사진 사용', '얼굴과 몸 형태가 함께 보이면 더 좋음', '의상 전체 모양이 보이는 이미지 선택', '샘플 친구와 샘플 의상도 바로 사용 가능'],
      progressTitle: '진행 상태',
  ...
  en: {
    hero: {
      ...
      body: 'Upload your dog or cat and instantly try different outfits with AI.',
  ...
  ja: {
    hero: {
      ...
      body: '犬や猫の写真をアップロードするだけで、AI がいろいろな衣装をすぐに試着プレビューします。',
  ...
  zh: {
    hero: {
      ...
      body: '上传狗狗或猫咪照片后，就能立刻用 AI 试不同服装风格。',
