...
const traditionalPromptHints: Record<TraditionalOutfitCountry, OutfitPromptHints> = {
  korea: {
    ...
    pose: 'use a poised upright pose with soft hand placement that respects the flowing hanbok silhouette',
  ...
  japan: {
    ...
    pose: 'use a composed upright pose with restrained hand movement and balanced shoulders',
  ...
  china: {
    ...
    pose: 'use a straight confident pose with subtle graceful arm placement that emphasizes the vertical silhouette',
  ...
  india: {
    ...
    pose: 'use a graceful pose that lets the drape and pallu fall naturally with confident posture',
    background: 'a warm festive architectural backdrop with refined ornamental detail',
  },
  vietnam: {
    outfitName: 'Ao dai',
    mood: 'clean and elegant ao dai styling',
    pose: 'use a tall relaxed pose that highlights the long vertical line and side panels',
  ...
  thailand: {
    ...
    pose: 'use an upright dignified pose with neatly arranged hands and balanced shoulders',
  ...
  indonesia: {
    ...
    pose: 'use a composed formal pose that keeps the waistline and fitted blouse elegant',
  ...
  spain: {
    ...
    pose: 'use a confident expressive pose that suits flamenco movement without distorting the garment',
